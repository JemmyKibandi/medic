...
<!-- Mirrored from index/tf/html/vicodin-preview/vicodin/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Feb 2024 08:54:51 GMT -->
                    ...
                    <div class="row">
                            ...
                            <div class="account-login-inner">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <input type="text" name="product_price" placeholder="Email*" />
                                    </div>
                                    <div class="col-lg-12">
                                        <!-- Third input box -->
                                        <label>Product Price on Sale</label>
                                        <input type="text" name="product_price_on_sale" placeholder="Email*" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-4">
                            ...
                            <div class="account-login-inner">
                                <div class="row pt-6">
                                    <div class="col-lg-12 mb-3">
                                        <!-- Fourth input box with bottom margin -->
                                        <label class="mt-4">Product Category</label><br>
...
<!-- Mirrored from index/tf/html/vicodin-preview/vicodin/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Feb 2024 08:54:52 GMT -->
